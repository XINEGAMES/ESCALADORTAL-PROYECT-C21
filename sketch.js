...
function preload(){
  towerImg = loadImage("pared-piedra-roca-ladrillos-fondo-juego-musgo-antiguo-estilo-dibujos-animados_191307-533.webp");
  doorImg = loadImage("towerportal.png");
  climberImg = loadImage("climber.png");
  ghostImg = loadImage("escalador.png");
  spookySound = loadSound("y2mate.com - Los cantos de aves más hermosos.mp3");
}
